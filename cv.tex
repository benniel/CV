...
\item[] \textbf{\textit{Programmer and Researcher}} \hfill \textbf{January 2012 to  present}
        ...
        \end{innerlist}
\end{outerlist}
\reference{Prof. A.P. Engelbrecht \\ .\hfill (engel@cs.up.ac.za)}{the Department of Computer Science} \\
